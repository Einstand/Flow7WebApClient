...
<%
   ...
   string member1st=pQueryString.Get("member1st");
   string member2nd=pQueryString.Get("member2nd");
   ...
   sJson+="}";
   sJson=sJson.Replace("%A", applicantId)
              .Replace("%B", applicantDept)
              .Replace("%D", diagramGuid)
              .Replace("%T", authToken)
              .Replace("%R", requisitionId)
              .Replace("%M1", member1st)
              .Replace("%M2", member2nd);
